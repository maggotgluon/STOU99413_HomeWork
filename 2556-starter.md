...
ให้นักศึกษาทดลองรัน (run) โปรแกรมที่กำหนดให้ต่อไปนี้  ด้วยโปรแกรมอีคลิปส์ (Eclipse)
...
public class Calculator extends JFrame implements ActionListener{
	 ...
	 */
	Font f12 = new Font("Comic Sans MS", 0, 12);
	Font f121 = new Font("Comic Sans MS", 1, 12);
	...
	public Calculator() {
		...
		jmenuitemAbout = new JMenuItem("About STOU Calculator");
...
class CustomABOUTDialog extends JDialog implements ActionListener {
	...
	CustomABOUTDialog(JFrame parent, String title, boolean modal) {
		...
		text.append("STOU Calculator Information\n\n");
		text.append("Developer:	STOU\n");
		text.append("Version:	1.0");
		
		JTextArea jtAreaAbout = new JTextArea(5, 21);
		jtAreaAbout.setText(text.toString());
		jtAreaAbout.setFont(new Font("Comic Sans MS", 1, 13));
...
ซึ่งผลลัพธ์ที่ได้จะเป็นดังภาพต่อไปนี้

![Image of Yaktocat](https://maggotgluon.github.com/STOU99413_HomeWork/StarterCode/99413Home-starter.png)

ให้นักศึกษาทำการแก้ไขโปรแกรม  เพื่อให้การทำงานของโปรแกรมได้ผลลัพธ์ดังภาพต่อไปนี้
![Image of Yaktocat](https://maggotgluon.github.com/STOU99413_HomeWork/StarterCode/99413Home-solution.png)
